...
public class CameraActivity extends AppCompatActivity {
    ...
    public static final String PROFILE_PICTURE_FILE_NAME = "profile";
    ...
    public void addCamera() {
        ...
        getSupportFragmentManager()
                .beginTransaction()
                .replace(R.id.content, cameraFragment, TAG)
    ...
    private void createFilePath() {
        try {
            File directoryPath = new File(this.getFilesDir(), PROFILE_PICTURE_PATH);
