...
public class Data extends SQLiteOpenHelper {
    ...
    private static final String TAG = "sqlite_data";
    ...
    private static final String DATABASE_NAME = "brightgascustomer.db";
    ...
    public void insertUser() {
        ...
        contentValues.put(COLUMN_PICTURE, User.picture);
    ...
    public void getUser() {
        try {
            ...
            if (cursor.moveToFirst()) {
                ...
                User.picture = cursor.getString(2);
            }
            cursor.close();
        } catch (Exception ex) {
