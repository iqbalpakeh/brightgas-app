...
public class Network {
    ...
    private static final String GCM_SERVER_API_KEY = "AIzaSyAIo8MlLdAZ6el3ZOyn0_qo3lr0CZscogg";
    public static final String GCM_SENDER_ID = "707785507287";
    private static final String API_KEY = "2ee046072e43bbeb91f88e1a051bfe1656b989779e320";
    private static final String IMAGE_LOW_PREFIX = "@2x";
    private static final String IMAGE_MED_PREFIX = "@3x";
    private static final int IMAGETYPE_ORIGNAL = 0;
    private static final int IMAGETYPE_LOW = 1;
    private static final int IMAGETYPE_MED = 2;

    //private static final String serverAddress = "http://192.168.0.10/syscleaning/";
    private static final String serverAddress = "http://103.252.100.29/pertamina/app_brightgas/";

    private static final String baseUrl = serverAddress + "api/";
    private static final String baseUrlImage = serverAddress + "assets/photo/";

    private static final String baseUrlRajaOngkir = "http://api.rajaongkir.com/basic/";
    private static final String API_KEY_RAJA_ONGKIR = "91322fcf2fb3fb22f03d8d91d8d8380e";
        ...
        try {
            ...
            if (resEntityGet != null) {
                try {
                    ...
                    Log.d(TAG, "network error " + ex.toString());
                }
            }
        } catch (Exception ex) {
            Log.d(TAG, "network error " + ex.toString());
