...
public class AdapterDriverPicker extends ArrayAdapter<IdName> {
    ...
    public AdapterDriverPicker(Context context, ArrayList<IdName> datas) {
        super(context, R.layout.item_driver_picker,datas);
        this.datas = datas;
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        int resId = R.layout.item_driver_picker;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ratingBar.setRating(random.nextInt(5));
        TextView deliveryCount = (TextView)rootView.findViewById(R.id.deliverycount);
        deliveryCount.setText(""+random.nextInt(5));
        return rootView;
    }
