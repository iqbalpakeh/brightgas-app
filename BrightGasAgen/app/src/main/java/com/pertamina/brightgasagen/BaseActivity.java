...
public class BaseActivity extends AppCompatActivity {
    ...
    public static final String PREF_NAME = "prefnamebrightgasdriver";
    ...
    protected void onStart() {
        ...
        filter.addAction("com.pertamina.brightgasagen");
...
//            fm.popBackStack(null, FragmentManager.POP_BACK_STACK_INCLUSIVE);
    ...
    public boolean isValidString(String val) {
        if (val == null)
            return false;
        else if (val.isEmpty() || val.equals("null") || val.equals("NULL")) {
            return false;
        }
        return true;
    }
