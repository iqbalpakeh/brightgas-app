...
import com.pertamina.brightgasagen.InterfacePesanItemDropdown;
...
public class PesanItemDropdownHelper {
    ...
    public PesanItemDropdownHelper(final Context context, View rootView, String baseTitle, final InterfacePesanItemDropdown interfacePesanItemDropdown1){
        ...
        dropdown.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int visibility;
                if(!isDropdown){
                    dropdown.startAnimation(((BaseActivity)context).createRotateAnimation(180,0,0.5f,0.5f,300,0,null));
                    visibility = View.GONE;
                }else{
                    dropdown.startAnimation(((BaseActivity)context).createRotateAnimation(0,180,0.5f,0.5f,300,0,null));
