...
public class Data extends SQLiteOpenHelper {
    ...
    public static final String COLUMN_AGEN_NAME = "_agen_name";
    public static final String COLUMN_AGEN_ID = "_agen_id";

    private static final String DATABASE_NAME = "brigtgasdriver.db";
    ...
    private static final String DATABASE_USER = CREATE_TABLE
            ...
            +COLUMN_AGEN_NAME+TEXT+QOMAS_SEPARATOR
            +COLUMN_AGEN_ID+TEXT+
            END_OF_LINE;
    ...
    private static final String[] allColumnsRequest = {COLUMN_ID,COLUMN_NAME};
    private static final String[] allColumnsLoginType = {COLUMN_ID,COLUMN_NAME};
    private static final String[] allColumnsSearchHistory = {COLUMN_NAME};
    private static final String[] allColumnsUser = {COLUMN_ID,COLUMN_NAME,COLUMN_AGEN_NAME,COLUMN_AGEN_ID};
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        Log.d("gugum", "upgrade data");
        switch (oldVersion){
            case 1:
                db.execSQL(ALTER_TABLE + TABLE_USER + ADD_COLUMN + COLUMN_AGEN_ID + TEXT);
        }
    }
    ...
    public void insertUser(){
        ...
        contentValues.put(COLUMN_AGEN_NAME,User.agenName);
        contentValues.put(COLUMN_AGEN_ID,User.agenId);
    ...
    public String getRequest(String id){
        ...
        try{
            ...
            Log.d("gugum","ERROR GET REQUEST : "+ex.toString());
        }
        return result;
    }

//    public int getLoginType(){
//        int result = LoginActivity.LOGIN_STATUS_NONE;
    ...
    public void getUser(){
        try{
            ...
            if(cursor.moveToFirst()){
                ...
                User.agenName = cursor.getString(2);
                User.agenId = cursor.getString(3);
            }
            cursor.close();
        }catch (Exception ex){
