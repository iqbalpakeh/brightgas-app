...
public class Data extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "brigtgasse.db";
    ...
    private static final String DATABASE_USER = CREATE_TABLE
            ...
            + COLUMN_ROLE_ID + INTEGER + QOMAS_SEPARATOR
            + COLUMN_ROLE_NAME + TEXT + QOMAS_SEPARATOR
            + COLUMN_TOKEN + TEXT +
            END_OF_LINE;
    ...
    private static final String[] allColumnsUser = {COLUMN_NAME, COLUMN_ROLE_ID, COLUMN_ROLE_NAME, COLUMN_TOKEN};
    ...
    public void insertUser() {
        ...
        contentValues.put(COLUMN_NAME, User.username);
        contentValues.put(COLUMN_ROLE_ID, User.role_id);
        contentValues.put(COLUMN_ROLE_NAME, User.role_name);
    ...
    public void getUser() {
        try {
            ...
            if (cursor.moveToFirst()) {
                ...
                User.role_id = cursor.getInt(1);
                User.role_name = cursor.getString(2);
